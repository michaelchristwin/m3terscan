 ...
 * @returns {any}
 */
export function filter(data, search_id, search_name) {
    const ptr0 = passStringToWasm0(search_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(search_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.filter(data, ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {Promise<any>}
 */
export function process_json(json_value) {
    const ret = wasm.process_json(json_value);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper437 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 59, __wbg_adapter_50);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_filter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
